      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="bg-[#1a1a1a] border border-[#333] p-8 max-w-md text-center">
          ...
          <p className="text-gray-400 mb-6">
            Call Lab Pro checkout is being set up. Please check back shortly.
          </p>
          <a href="/call-lab-pro" className="inline-block bg-[#E51B23] text-white px-6 py-3 font-semibold hover:bg-[#c41820] transition-colors">
            GO BACK
          </a>
        </div>
      </div>
