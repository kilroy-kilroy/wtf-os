  ...
  return (
    <div className="min-h-screen bg-black py-12 px-4 font-poppins">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 text-[10px] text-[#666] max-w-3xl mx-auto leading-relaxed">
          <p className="uppercase font-bold mb-1">Disclaimer</p>
          <p>
            This report is generated by Artificial Intelligence (the Discovery Lab research engine) and is intended for
            informational and sales-preparation purposes only. The insights are assembled from public data and automated
            research, which can be incomplete or incorrect. Verify key facts &mdash; such as a person&apos;s role,
            company details, revenue, and any specific claims &mdash; before relying on them in a conversation. KLRY, LLC
            makes no warranties regarding the completeness or accuracy of this analysis.
          </p>
        </div>
