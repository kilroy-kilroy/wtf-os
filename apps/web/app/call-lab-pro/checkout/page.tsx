...
type ProductChoice = 'call-lab-pro' | 'bundle'
...
function CheckoutContent() {
  ...
  const [selectedProduct, setSelectedProduct] = useState<ProductChoice>('call-lab-pro')
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="space-y-4 mb-8">
        {/* Call Lab Pro Only */}
        <button
          onClick={() => setSelectedProduct('call-lab-pro')}
          className={`w-full p-6 border-2 text-left transition-all ${
            selectedProduct === 'call-lab-pro'
        ...
        >
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-xl font-bold text-white font-anton">CALL LAB PRO</h3>
              <p className="text-gray-400 mt-1">
                AI-powered call analysis & coaching
              </p>
              <ul className="mt-3 space-y-1 text-sm text-gray-500">
                <li>• Unlimited call analyses</li>
            ...
            <div className="text-right">
              <span className="text-2xl font-bold text-white">${prices['call-lab-pro']}</span>
          ...
          <div className="flex justify-between items-start mt-2">
            <div>
              ...
              <p className="text-[#FFDE59] mt-1 font-semibold">
                Call Lab Pro + Discovery Lab Pro
              </p>
              <ul className="mt-3 space-y-1 text-sm text-gray-500">
                <li>• Everything in Call Lab Pro</li>
                <li className="text-[#FFDE59]">• + Pre-call intelligence blueprints</li>
                <li className="text-[#FFDE59]">• + Company & prospect research</li>
                <li className="text-[#FFDE59]">• + Conversation playbooks</li>
              </ul>
            </div>
            <div className="text-right">
      ...
      <p className="text-center mt-6">
        <a href="/call-lab-pro" className="text-gray-500 hover:text-white text-sm">
          ← Back to Call Lab Pro
        </a>
      </p>
    </div>
  )
