...
export const InputForm: React.FC<Props> = ({ onSubmit, isLoading, savedWebhookUrl, onSaveWebhook }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-[#1a1a1a] border-2 border-brand-red p-1 shadow-[8px_8px_0px_0px_#E51B23] relative">
      ...
      <div className="bg-black p-8 relative overflow-hidden">
        ...
        <div className="mb-8 text-center">
          <h2 className="text-4xl text-white mb-2 font-anton">Initialize <span className="text-brand-yellow">Analysis</span></h2>
        ...
        >
          ...
          <div className="bg-[#1a1a1a]/30 border border-gray-800 p-4 mb-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#1a1a1a] border border-[#1a1a1a] focus:border-brand-red text-white p-3 outline-none transition-colors placeholder-gray-600"
              autoComplete="off"
              data-lpignore="true"
            />
          </div>
