    ...
    <div className="min-h-screen bg-black">
      ...
      {sessionId && amountTotal && (
        <PurchaseTracker
          ...
          items={[createPurchaseItem('bundle', (plan as 'solo' | 'team') || 'solo', amountTotal)]}
        />
      )}
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 font-anton">
            Welcome to the SalesOS Bundle!
          </h1>
          <p className="text-xl text-gray-400">
            You now have access to both Call Lab Pro and Discovery Lab Pro.
        ...
        <div className="bg-[#1a1a1a] border border-[#333] p-8 mb-8">
          ...
          <ul className="text-left text-gray-400 space-y-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Generate a Discovery Blueprint before your next call</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-[#FFDE59]">3.</span>
              <span>Upload your call transcript for AI analysis</span>
            </li>
            <li className="flex items-start gap-3">
