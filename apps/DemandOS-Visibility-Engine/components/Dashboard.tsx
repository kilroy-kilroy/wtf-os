...
export const Dashboard: React.FC<Props> = ({ data, onReset }) => {
  ...
  const handlePrint = () => {
    ...
    if (window.html2pdf) {
         // @ts-ignore
        const opt = {
            margin: 0.2, // Slight margin to prevent clipping
            filename: `DemandOS-Report-${data.brandName.replace(/\s+/g, '-')}.pdf`,
            image: { type: 'jpeg', quality: 0.98 },
            html2canvas: { scale: 2, useCORS: true, letterRendering: true },
            jsPDF: { unit: 'in', format: 'letter', orientation: 'portrait' },
            pagebreak: { mode: ['avoid-all', 'css', 'legacy'] } // Prevent cutting elements in half
        };
        // @ts-ignore
  ...
  const handleShare = () => {
    ...
    // Use the feed URL which allows pre-filling the post body text
  ...
  const handleGenerateDraft = async (topic: string) => {
    ...
    const draft = await generateQuickPost(topic, data.brandArchetype.name, data.brandName);
  ...
  return (
    <div id="dashboard-content" className="min-h-screen bg-black text-white pb-20 font-poppins">
      ...
      {/* INSTANT FIX MODAL */}
      {draftModalOpen && (
        <div className="fixed inset-0 z-[100] bg-black/90 flex items-center justify-center p-4 backdrop-blur-sm no-print">
          <div className="bg-brand-gray border-2 border-brand-yellow w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl">
      ...
      {/* Header */}
      <header className="border-b-4 border-brand-red bg-brand-gray p-6 sticky top-0 z-50 shadow-lg no-print">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <button onClick={handleDownloadJson} className="bg-brand-gray border border-gray-600 text-white px-4 py-2 font-anton uppercase hover:border-brand-yellow hover:text-brand-yellow transition-colors flex items-center gap-2">
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-12 mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 section-break">
          
          {/* Score Card */}
          <div className="lg:col-span-4 bg-brand-gray border border-gray-800 p-8 relative overflow-hidden flex flex-col items-center justify-center min-h-[300px] group hover:border-brand-red transition-colors">
        ...
        {data.narrativeDissonance && (
            <div className="section-break bg-black border border-gray-800 p-1">
        ...
        <div className="border border-brand-red bg-black p-1 section-break">
        ...
        <div className="section-break">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.competitors.map((comp, idx) => (
                  <div key={idx} className="bg-brand-gray border border-gray-800 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 section-break">
            {/* VVV Audit */}
            <div className="bg-brand-gray border border-gray-800 p-8 flex flex-col">
            ...
            <div className="bg-black border border-gray-800 p-8 flex flex-col">
                ...
                <div className="space-y-4 flex-grow">
                    {data.coreStrengths.map((strength, idx) => (
                        <div key={idx} className="flex items-start gap-4 p-4 bg-brand-gray border border-gray-800 hover:border-brand-yellow transition-all group">
        ...
        <div className="bg-brand-gray border border-gray-800 p-8 section-break">
        ...
        <div className="section-break">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* YouTube - ACTION */}
            <div className="bg-brand-gray p-6 border-t-4 border-[#FF0000]">
             ...
             {/* Podcasts - ACTION */}
             <div className="bg-brand-gray p-6 border-t-4 border-brand-yellow">
             ...
             {/* Events - ACTION */}
             <div className="bg-brand-gray p-6 border-t-4 border-brand-red">
        ...
        <div className="bg-white text-black p-8 shadow-2xl section-break">
        ...
        {/* Footer CTA */}
        <div className="text-center pt-12 pb-6 border-t border-gray-800 no-print">
