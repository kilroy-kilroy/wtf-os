...
--
-- IMPORTANT: Tables are created first, then RLS policies are added afterward
...
DROP TRIGGER IF EXISTS trigger_increment_repurpose_count ON repurposes;
...
DROP TRIGGER IF EXISTS set_updated_at_content_orgs ON content_orgs;
CREATE TRIGGER set_updated_at_content_orgs
  BEFORE UPDATE ON content_orgs
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS set_updated_at_content_profiles ON content_profiles;
CREATE TRIGGER set_updated_at_content_profiles
  BEFORE UPDATE ON content_profiles
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS set_updated_at_voice_profiles ON voice_profiles;
CREATE TRIGGER set_updated_at_voice_profiles
  BEFORE UPDATE ON voice_profiles
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS set_updated_at_content_sources ON content_sources;
CREATE TRIGGER set_updated_at_content_sources
  BEFORE UPDATE ON content_sources
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS set_updated_at_repurposes ON repurposes;
CREATE TRIGGER set_updated_at_repurposes
  BEFORE UPDATE ON repurposes
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS set_updated_at_content_call_imports ON content_call_imports;
CREATE TRIGGER set_updated_at_content_call_imports
  BEFORE UPDATE ON content_call_imports
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS set_updated_at_content_notification_prefs ON content_notification_prefs;
